...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo $this->language; ?>" lang="<?php echo $this->language; ?>" >
  ...
  <head>
    ...
    <!--[if gt IE 8]><!--><link rel="stylesheet" media="screen" href="<?php echo $this->baseurl ?>/templates/<?php echo $this->template; ?>/assets/stylesheets/govuk-frontend-2.0.0.min.css" />
