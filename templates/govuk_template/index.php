...
<head>
  ...
  <link rel="shortcut icon" sizes="16x16 32x32 48x48" href="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/assets/images/favicon.ico" type="image/x-icon" />
  <link rel="mask-icon" href="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/assets/images/govuk-mask-icon.svg" color="blue">
  <link rel="apple-touch-icon" sizes="180x180" href="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/assets/images/govuk-apple-touch-icon-180x180.png">
  <link rel="apple-touch-icon" sizes="167x167" href="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/assets/images/govuk-apple-touch-icon-167x167.png">
  <link rel="apple-touch-icon" sizes="152x152" href="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/assets/images/govuk-apple-touch-icon-152x152.png">
...
<body class="govuk-template__body app-body-class">
  ...
  <header class="govuk-header " role="banner" data-module="header">
    <div class="govuk-header__container govuk-width-container">
      ...
      <div class="govuk-header__logo">
        <a href="<?php echo $this->baseurl; ?>" class="govuk-header__link govuk-header__link--homepage">
          <span class="govuk-header__logotype">
            ...
            <svg role="presentation" focusable="false" class="govuk-header__logotype-crown" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 132 97" height="32" width="36">
              ...
              <image src="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/assets/images/gov.uk_logotype_crown.svg" class="govuk-header__logotype-crown-fallback-image"></image>
            </svg>
	...
	<jdoc:include type="modules" name="phase-banner" />
    ...
    <main class="govuk-main-wrapper app-main-class" id="main-content" role="main">
	  	...
	  	<div class="govuk-grid-row">
			...
			<div class="govuk-grid-column-one-third">
				<jdoc:include type="modules" name="one-third" />
      		</div>
	    </div>							  
    </main>
  </div>
  ...
  <script src="<?php echo $this->baseurl ?>/templates/<?php echo $this->template; ?>/assets/javascripts/all.js"></script>
</body>
